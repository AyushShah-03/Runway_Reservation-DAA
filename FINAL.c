...
int actselection(int i)
{
    ...
    printf("Selected Aircrafts and their allocated time for Runway '%d' are as follows :-\n",i);
    printf("\n%d\t%s\t%d\t%d\n", temp->srno, temp->name, temp->start, temp->finish);
    arr[0]=temp->srno;
...
int main()
{
    ...
    printf("\n");
    printf("\v\t*****************{AIRPORT RUNWAY ALLOCATION SYSTEM USING ACTIVITY SCHEDULING}**********************\t\n");
    printf("\t_____________________________________________________________________________________________________\t\n");
    printf("\v\t+++++++++++++++++++++++++++|Welcome to Runway allocation Program|++++++++++++++++++++++++++++++\t\n\n");
    while (1)
    {
        printf("\n\nFunctionality of this allocation program:-\n\n1. Insert an Aircraft's details(A_no,time).\n2. Delete an Aircraft's details.\n3. Display all Aircraft's and their details.\n4. Display the allocated time schedule and runways.\n5. List Copied.\n6. Exit the system.");
        ...
        {
        case 1:
            printf("Enter the Aircraft's number :- ");
            fflush(stdin);
        ...
        case 2:
            printf("Enter the index of the Aircraft's details to be Deleted :- ");
            scanf("%d",&key);
